...
A Bandgap Reference (BGR) circuit generates a stable reference voltage that is nearly independent of temperature, power supply variations, and process variations. This makes BGR circuits essential in analog, mixed-signal, and digital integrated circuits.
...
The final output is a reference voltage that is independent of temperature, and the combined circuit looks as follows:
